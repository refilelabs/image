...
export type MimeTypes =
  | keyof typeof outputFileEndings
  | keyof typeof inputFileEndings
...
export function getEndingMimeType(ending: string): MimeTypes | undefined {
  ...
  return Object.entries(inputFileEndings).find(
    ([, ext]) => ext === endingLower
  )?.[0] as MimeTypes | undefined;
}
...
export const supportedFormats = [
  ...
  // { format: "Raw", decoding: "Yes", encoding: "No" },
];
